...
8. Create the configuration. The UI returns a **listener URL** and a one-time **generated secret** — copy the generated secret immediately because it is shown only once.
