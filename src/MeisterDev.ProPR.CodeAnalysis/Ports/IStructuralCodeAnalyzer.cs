...
namespace MeisterDev.ProPR.CodeAnalysis;
...
///         backend (TS/TSX/JS/Py/Go/Java/Ruby, syntactic) in <c>MeisterDev.ProPR.CodeAnalysis.TreeSitter</c>
///         and the Roslyn-syntax backend (C#, syntactic) in <c>MeisterDev.ProPR.CodeAnalysis.Roslyn</c>.
