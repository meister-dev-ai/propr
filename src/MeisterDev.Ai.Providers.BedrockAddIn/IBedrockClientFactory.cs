...
{
    /// <summary>
    ///     Builds the inference client for an endpoint, or <see langword="null" /> when the host supplied no
    ///     client factory and there is therefore no transport to send on.
    /// </summary>
    ...
    ///     from it, or when the host supplied no client factory.
    /// </summary>
    /// <param name="endpoint">The stored provider endpoint.</param>
    /// <exception cref="InvalidOperationException">The endpoint names no region, or carries no access key.</exception>
