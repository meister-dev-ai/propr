...
public interface ILogicalModelCatalogRepository
{
    ...
    /// </summary>
    /// <exception cref="MeisterDev.ProPR.Application.Exceptions.SystemTenantLogicalModelCatalogException">
    ///     The tenant is the system tenant (or the empty tenant), which stores per-client overrides only.
    /// </exception>
    /// <exception cref="MeisterDev.ProPR.Application.Exceptions.DuplicateLogicalModelException">
    ...
    /// </summary>
    /// <exception cref="MeisterDev.ProPR.Application.Exceptions.LogicalModelReferenceInvalidException">
    ...
    ///     not found; throws <see cref="MeisterDev.ProPR.Application.Exceptions.DuplicateLogicalModelException" /> if
    ...
    ///     is not found; throws <see cref="MeisterDev.ProPR.Application.Exceptions.DuplicateLogicalModelException" /> if
