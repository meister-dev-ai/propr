...
public interface ILogicalModelResolver
{
    ...
    ///     (<see cref="MeisterDev.ProPR.Application.Exceptions.LogicalModelNotFoundException" />) or is not a chat model
    ///     (<see cref="MeisterDev.ProPR.Application.Exceptions.LogicalModelCapabilityMismatchException" />).
    /// </summary>
