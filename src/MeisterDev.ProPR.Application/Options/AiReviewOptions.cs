...
public sealed class AiReviewOptions
{
    ...
    /// <summary>
    ///     Maximum agentic loop iterations for <see cref="MeisterDev.ProPR.Domain.Enums.FileComplexityTier.Low" /> files.
    ...
    /// <summary>
    ///     Maximum agentic loop iterations for <see cref="MeisterDev.ProPR.Domain.Enums.FileComplexityTier.Medium" /> files.
    ...
    /// <summary>
    ///     Maximum agentic loop iterations for <see cref="MeisterDev.ProPR.Domain.Enums.FileComplexityTier.High" /> files.
