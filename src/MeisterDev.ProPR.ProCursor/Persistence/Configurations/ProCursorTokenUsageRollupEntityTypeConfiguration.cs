...
namespace MeisterDev.ProPR.ProCursor.Persistence.Configurations;

internal sealed class ProCursorTokenUsageRollupEntityTypeConfiguration : IEntityTypeConfiguration<ProCursorTokenUsageRollup>
{
