...
/// </summary>
public sealed partial class StubPullRequestFetcher(ILogger<StubPullRequestFetcher> logger)
    : IPullRequestFetcher, IProviderPullRequestFetcher
{
    ...
    [LoggerMessage(
        ...
        Message =
            "ADO_STUB_PR is enabled — returning a fake pull request for PR#{PrId}. No real Azure DevOps connection will be made.")]
