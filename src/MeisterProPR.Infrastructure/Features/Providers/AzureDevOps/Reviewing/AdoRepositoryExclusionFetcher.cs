...
public partial class AdoRepositoryExclusionFetcher(
    ...
    ILogger<AdoRepositoryExclusionFetcher> logger) : IRepositoryExclusionFetcher, IProviderRepositoryExclusionFetcher
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            logger.LogDebug(
                ex,
                "Failed to fetch .meister-propr/exclude from {RepositoryId}@{Branch}; treating as absent",
                repositoryId,
                targetBranch);
            return null;
        }
