...
public sealed class LegacyReviewProtocolRecorderAdapter(IProtocolRecorder inner) : IReviewProtocolRecorder
{
    ...
    {
        return inner.BeginAsync(jobId, attemptNumber, label, fileResultId, connectionCategory, modelId, ct);
    }
    ...
    public Task RecordToolCallAsync(
        ...
        CancellationToken ct = default)
    {
        return inner.RecordToolCallAsync(protocolId, toolName, arguments, result, iteration, ct);
    }
    ...
    public Task SetCompletedAsync(
        ...
        CancellationToken ct = default)
    {
        return inner.SetCompletedAsync(
            protocolId,
            outcome,
            totalInputTokens,
            totalOutputTokens,
    ...
    public Task AddTokensAsync(
        ...
        CancellationToken ct = default)
    {
        return inner.AddTokensAsync(protocolId, inputTokens, outputTokens, connectionCategory, modelId, ct);
    }
    ...
    public Task RecordMemoryEventAsync(
        ...
        CancellationToken ct = default)
    {
        return inner.RecordMemoryEventAsync(protocolId, eventName, details, error, ct);
    }
    ...
    public Task RecordDedupEventAsync(
        ...
        CancellationToken ct = default)
    {
        return inner.RecordDedupEventAsync(protocolId, eventName, details, error, ct);
    }
}
