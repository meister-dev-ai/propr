    ...
    ILogicalModelResolver? logicalModelResolver = null) : IFileByFileReviewOrchestrator
{
        ...
        CancellationToken ct)
    {
        ...
        // The factory-null case goes through the same log as a factory that answers null: a pass list
        // carrying pr_wide entries a composition cannot run is a skip worth a line, wherever the null is.
        var generator = prWideCandidateGeneratorFactory?.Invoke();
