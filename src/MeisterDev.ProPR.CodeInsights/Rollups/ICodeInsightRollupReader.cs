...
/// </summary>
/// <remarks>
///     Every method returns a materialized result, not a deferred query. Callers rely on that: an endpoint reads
///     one series and projects it twice, once for the points and once for the distinct keys, and a lazy sequence
///     would turn that into two database round trips.
/// </remarks>
