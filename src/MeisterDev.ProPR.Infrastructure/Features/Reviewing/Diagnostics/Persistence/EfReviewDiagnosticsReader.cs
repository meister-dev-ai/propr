...
namespace MeisterDev.ProPR.Infrastructure.Features.Reviewing.Diagnostics.Persistence;
            ...
            foreach (var proj in selectedProtocolsProj)
            {
                ...
                foreach (var evtProj in proj.Events)
                {
                    var evt = new ProtocolEvent
                    {
                        ...
                        CacheWriteTokens = evtProj.CacheWriteTokens,
                        ReasoningTokens = evtProj.ReasoningTokens,
