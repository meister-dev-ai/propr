...
namespace MeisterDev.ProPR.Infrastructure.Migrations
{
    ...
    [Migration("20260325121941_IncreaseProtocolEventTextColumns")]
    partial class IncreaseProtocolEventTextColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ReviewJobProtocol", b =>
                {
                    b.HasOne("MeisterDev.ProPR.Domain.Entities.ReviewJob", null)
                        .WithOne("Protocol")
                        .HasForeignKey("MeisterDev.ProPR.Domain.Entities.ReviewJobProtocol", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
