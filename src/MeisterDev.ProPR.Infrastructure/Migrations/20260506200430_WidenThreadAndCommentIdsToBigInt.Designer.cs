...
namespace MeisterDev.ProPR.Infrastructure.Migrations
{
    ...
    [Migration("20260506200430_WidenThreadAndCommentIdsToBigInt")]
    partial class WidenThreadAndCommentIdsToBigInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorIndexJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorIndexSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorKnowledgeChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorSymbolEdge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorSymbolRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorTokenUsageEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorTokenUsageRollup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorIndexJob", b =>
                {
                    ...
                    b.HasOne("MeisterDev.ProPR.Domain.Entities.ProCursorTrackedBranch", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MeisterDev.ProPR.Domain.Entities.ProCursorIndexSnapshot", b =>
                {
                    b.HasOne("MeisterDev.ProPR.Domain.Entities.ProCursorIndexSnapshot", null)
                        .WithMany()
