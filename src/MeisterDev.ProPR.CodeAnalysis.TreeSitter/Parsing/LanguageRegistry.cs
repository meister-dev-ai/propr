...
namespace MeisterDev.ProPR.CodeAnalysis.TreeSitter.Parsing;
...
internal static class LanguageRegistry
{
    ...
    {
        var resourceName = $"MeisterDev.ProPR.CodeAnalysis.TreeSitter.Queries.{LanguageFolder(language)}.tags.scm";
