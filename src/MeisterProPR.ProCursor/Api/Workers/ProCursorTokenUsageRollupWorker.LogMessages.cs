...
{
    [LoggerMessage(Level = LogLevel.Information, Message = "ProCursorTokenUsageRollupWorker started (interval: {IntervalSeconds}s)")]
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "ProCursor token usage rollup cycle completed with {RefreshedBucketCount} refreshed buckets")]
    private static partial void LogCycleCompleted(ILogger logger, int refreshedBucketCount);

    [LoggerMessage(Level = LogLevel.Information, Message = "ProCursor token usage retention completed (events deleted: {DeletedEventCount}, rollups deleted: {DeletedRollupCount})")]
    private static partial void LogRetentionCompleted(ILogger logger, int deletedEventCount, int deletedRollupCount);

    [LoggerMessage(Level = LogLevel.Error, Message = "ProCursorTokenUsageRollupWorker: unhandled exception in rollup cycle - worker continues")]
