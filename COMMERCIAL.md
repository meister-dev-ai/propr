...
Perfect for individuals, home labs, and open-source projects.

- **Cost:** Free.
- **Self-Hosting:** Unlimited.
- **The Condition:** If you modify the code and make it available over a network (SaaS), you must release your modified
  source code under the same AGPLv3 license.
...
| Proprietary Modifications | ❌ Not Allowed (Must share code)  | ✅ Keep your changes private   |
| SaaS / Managed Hosting    | ⚠️ Must open-source entire stack | ✅ Full Commercial SaaS Rights |
| Professional Support      | Best Effort                      | ✅ Priority (Email/Slack/SLA)  |
| Consulting & Setup        | Self-Service                     | ✅ Available as Add-on         |
| Legal Indemnity           | None                             | ✅ Included                    |
