...
.pr-number { font-weight: 700; color: var(--color-text); }
...
.event-reason { font-size: 0.85rem; color: var(--color-text-muted); background: rgba(0,0,0,0.2); padding: 0.5rem; border-radius: var(--radius-sm); margin-bottom: 0.75rem; border: 1px solid rgba(255,255,255,0.03); }
...
.empty-state-v2 h3 { color: var(--color-text); margin: 0 0 0.5rem; }
