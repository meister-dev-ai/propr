...
import type { ClientListItem } from '@/features/clients/view-models/useClientsViewModel'
...
function matchesSearch(client: ClientListItem, filter: string): boolean {
...
function matchesTenantFilter(client: ClientListItem, tenantFilterId?: string): boolean {
