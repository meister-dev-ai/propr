...
internal sealed class CodeInsightAudienceHarness
{
        ...
        string? minimumSampleSize = null)
    {
        ...
        this.ReviewerPerformance = new ReviewerPerformanceController(
            new StaticOptionsMonitor<CodeInsightsOptions>(
                new CodeInsightsOptions
                {
                    MinimumSealedPullRequests = minimumSampleSize is null
                        ? new CodeInsightsOptions().MinimumSealedPullRequests
                        : int.Parse(minimumSampleSize, CultureInfo.InvariantCulture),
                }),
            resolver,
            this.Clients,
