...
/// <summary>
///     T034 — unit tests for <see cref="ReviewDiffProcessor.ClassifyTier" /> and
///     <see cref="ReviewDiffProcessor.CountChangedLines" />.
/// </summary>
public sealed class FileByFileReviewOrchestratorTierTests
{
    ...
    public void ClassifyTier_10LineDiff_ReturnsLow()
    {
        ...
        Assert.Equal(FileComplexityTier.Low, ReviewDiffProcessor.ClassifyTier(file));
    }
    ...
    public void ClassifyTier_100LineDiff_ReturnsMedium()
    {
        ...
        Assert.Equal(FileComplexityTier.Medium, ReviewDiffProcessor.ClassifyTier(file));
    }
    ...
    public void ClassifyTier_300LineDiff_ReturnsHigh()
    {
        ...
        Assert.Equal(FileComplexityTier.High, ReviewDiffProcessor.ClassifyTier(file));
    }
    ...
    {
        Assert.Equal(0, ReviewDiffProcessor.CountChangedLines(null));
    }

    [Fact]
    public void CountChangedLines_EmptyDiff_ReturnsZero()
    {
        Assert.Equal(0, ReviewDiffProcessor.CountChangedLines(string.Empty));
    }
    ...
    {
        var diff = "+added line\n-removed line\n context line\n+another added";
        Assert.Equal(3, ReviewDiffProcessor.CountChangedLines(diff));
    }
    ...
    {
        var diff = "@@ -1,3 +1,4 @@\n+new line\n unchanged";
        Assert.Equal(1, ReviewDiffProcessor.CountChangedLines(diff));
    }
