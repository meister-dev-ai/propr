...
/// <summary>
///     Integration tests for <see cref="DbClientRegistry" /> against a real PostgreSQL instance.
...
public sealed class DbClientRegistryTests(PostgresContainerFixture fixture) : IAsyncLifetime
{
