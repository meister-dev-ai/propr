...
public sealed class VerticalSliceDependencyTests
{
    ...
    public void ModuleRegistrationRoots_ExistForAllPlannedModules()
    {
        var moduleFiles = new[]
        {
            "src/MeisterDev.ProPR.Infrastructure/Features/Reviewing/ReviewingModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/Crawling/CrawlingModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/Clients/ClientsModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/IdentityAndAccess/IdentityAndAccessModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/Mentions/MentionsModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/PromptCustomization/PromptCustomizationModuleServiceCollectionExtensions.cs",
            "src/MeisterDev.ProPR.Infrastructure/Features/UsageReporting/UsageReportingModuleServiceCollectionExtensions.cs",
        };
    ...
    {
        var contents = ReadRepoFile("src/MeisterDev.ProPR.Infrastructure/DependencyInjection/InfrastructureServiceExtensions.cs");
    ...
    {
        var contents = ReadRepoFile("src/MeisterDev.ProPR.Infrastructure/Features/UsageReporting/UsageReportingModuleServiceCollectionExtensions.cs");
