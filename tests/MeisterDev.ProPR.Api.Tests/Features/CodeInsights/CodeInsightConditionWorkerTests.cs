...
public sealed class CodeInsightConditionWorkerTests
{
    ...
    {
        var thresholds = CodeInsightConditionWorker.ResolveThresholds(Configuration());
    ...
    public void TheCorrectnessConditionSharesTheViewsSampleFloor()
    {
        ...
        var thresholds = CodeInsightConditionWorker.ResolveThresholds(Configuration(("CODE_INSIGHTS_MIN_SEALED_PULL_REQUESTS", "7")));
